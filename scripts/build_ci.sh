...
CONTAINER_ID=$(docker create -v $GITHUB_WORKSPACE:/tmp/workspace -it docker.pkg.github.com/suburbanembedded/stm32h7_qspi_boot/hadoucan-fw-tools:${GITHUB_REF##*/}  /bin/bash)

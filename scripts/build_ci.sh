...
CONTAINER_ID=$(docker create -v $GITHUB_WORKSPACE:/tmp/workspace -it docker.pkg.github.com/suburbanembedded/hadoucan-bootloader-fw/hadoucan-bootloader-tools:${GITHUB_REF##*/}  /bin/bash)
